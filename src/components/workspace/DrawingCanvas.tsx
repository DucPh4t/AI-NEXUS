      ...
      {selectedRoom && (
        <div className="absolute top-4 right-4 z-20 flex items-center gap-2 p-1.5 rounded-xl bg-[#12141a]/95 backdrop-blur-md border border-white/10 shadow-2xl font-mono text-xs animate-in fade-in slide-in-from-top-2 duration-150">
          <div className="px-3 py-1 bg-[#161822] border border-white/10 rounded-lg text-white font-bold flex items-center gap-2">
            ...
            <span className="text-white/50 font-normal">({selectedRoom.floorArea} m²)</span>
          </div>

          <button
            onClick={() => onEditBoundary(selectedRoom)}
            className="px-3 py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white/80 hover:text-white flex items-center gap-1.5 transition-colors cursor-pointer"
          ...
          <button
            ...
            className="amber-button px-3.5 py-1.5 text-xs font-semibold flex items-center gap-1.5 cursor-pointer shadow-sm"
          >
                  ...
                  return (
                    ...
                    >
                      <polygon
                        ...
                        strokeWidth={
                          isSelected || isSourceHighlighted ? '2.2' : '1.4'
                        }
                        strokeDasharray={
                        ...
                        room.vertices.map((v, vIdx) => (
                          <g key={vIdx}>
                            ...
                            <text
                              ...
                              y={v.y - 5}
                              fill="#ffc474"
                              className="font-mono text-[8.5px] font-bold pointer-events-none"
                            >
                              #{vIdx + 1}
                            </text>
                          </g>
